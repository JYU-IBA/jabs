...
#define DUAL_SCATTER_POLAR_STEPS_DEFAULT 21
#define DUAL_SCATTER_POLAR_SUBSTEPS_DEFAULT 9
#define DUAL_SCATTER_AZI_STEPS_DEFAULT 15
...
#define SCREENING_TABLE_SIZE (101)
