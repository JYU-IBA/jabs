...
script_command *script_commands_create(struct script_session *s) {
    ...
    const jibal_config_var vars[] = {
            ...
            {JIBAL_CONFIG_VAR_UNIT,   "incident_stop_step",          &sim->params->incident_stop_step,              NULL},
            {JIBAL_CONFIG_VAR_UNIT,   "incident_stop_step_sigmas",   &sim->params->incident_stop_step_sigmas,       NULL},
            {JIBAL_CONFIG_VAR_UNIT,   "incident_stop_step_min",      &sim->params->incident_stop_step_min,          NULL},
            {JIBAL_CONFIG_VAR_UNIT,   "incident_stop_step_max",      &sim->params->incident_stop_step_max,          NULL},
            {JIBAL_CONFIG_VAR_UNIT,   "exiting_stop_step",           &sim->params->exiting_stop_step,               NULL},
            {JIBAL_CONFIG_VAR_UNIT,   "exiting_stop_step_sigmas",    &sim->params->exiting_stop_step_sigmas,        NULL},
