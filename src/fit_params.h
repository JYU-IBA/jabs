...
void fit_params_print(const fit_params *params, int active, const char *pattern, size_t n_det); /* if active is TRUE print only active variables. pattern can be NULL to bypass matching. */
